  ...
  return (
    <div className="p-6 w-full max-w-2xl relative pb-10">
      ...
      <h1 className="font-semibold bg-yellow-100 text-yellow-600 border-l-4 border-yellow-500 p-4 rounded-md mb-6">
        Atualmente estou utilizando a API oficial do Twitter, que possui diversas limitações no plano gratuito.
        Isso poderá ser melhorado em versões futuras do projeto.
        Recomendo utilizar o usuário <strong>teste</strong> para testar o funcionamento do aplicativo — os dados retornados são mockados, criados apenas para fins de demonstração.
